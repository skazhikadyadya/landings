    ...
    function runScriptsParams(land_params) {
        if (typeof(jQuery) === 'undefined') {
            if (!jQ) {
                ...
                _scr.src = "../ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js";
